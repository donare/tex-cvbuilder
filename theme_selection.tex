...
\newcommand{\cvtheme}[1]{
    ...
    \ifthenelse{\equal{\detokenize{#1}}{\detokenize{bw-right}}}{%
    	\booltrue{reverse}
        \input{cv-themes/bw-right.tex}}{}
    \ifthenelse{\equal{\detokenize{#1}}{\detokenize{exige}}}{%
    	\booltrue{reverse}
        \input{cv-themes/exige.tex}}{}
...
\newcommand{\cltheme}[1]{
    ...
    \ifthenelse{\equal{\detokenize{#1}}{\detokenize{bw-right}}}{%
        \input{cover-letter-themes/bw-right.tex}}{}
    \ifthenelse{\equal{\detokenize{#1}}{\detokenize{exige}}}{%
        \input{cover-letter-themes/exige.tex}}{}
    \ifthenelse{\equal{\detokenize{#1}}{\detokenize{gray}}}{%
...
% Custom commands for CV and cover letter
...
\newcommand{\cvachievement}[3]{%
  \begin{tabularx}{\linewidth}{@{}p{0.08\columnwidth} @{\hspace{1ex}} >{\raggedright\arraybackslash}X@{}}
  \multirow{2}{*}{\small\color{sidebartext}#1} & \bfseries\textcolor{accent}{#2}\\
  & \small \itshape #3
  \end{tabularx}%
}
