...
\fancyhead[C]{%
    \begin{tikzpicture}[remember picture,overlay]
        \node [rectangle, fill=sidebarbackground, anchor=north east, minimum width=4cm, minimum height=\paperheight+2cm] at ($(current page.north east)+(1cm,1cm)$) {};
    \end{tikzpicture}
}
...
% Margins
\RequirePackage[left=1.5cm, right=4cm, top=1.5cm, bottom=1.5cm, footskip=0.5cm, headheight=0.5cm]{geometry}
